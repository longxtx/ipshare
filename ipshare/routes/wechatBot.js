...
var config = {
  token: 'itokenisok',
  appid: 'wx70e60ce8ecb61f2d',
  encodingAESKey: 'a3dyKr6ybgSe16KmbOrQ21dN8oft0HLIZ4bVBGOjGXh'
};

var WechatAPI = require('wechat-api');
var api = new WechatAPI('wx70e60ce8ecb61f2d',
  'd60ac20a0730da51aa0ffe7d0241b63c');
...
router.use('/', wechat(config.token).text(function(message, req, res, next) {
  ...
  switch (keyIndex) {
    ...
    default:
      res.reply({
        type: "text",
        content: '<a href="http://ipshare.leanapp.cn">抱歉！系统当前公用于测试用</a>'
      });
      break;
  }
